...
# books_with_details is a list that has 12 indices but 13 objects. Each index is an object that has key value pairs.
# Each object has a key value pair of "title", "author", and description. Each key has a value which is a string data type
#  I know that this is a list because of the square bracket notation. I know that the indices are objects because
# of the curly bracket notation. I know that the values are strings because of the quotes that surround the data.
...
# ----------------------------------------------
#  No return does not print anything out!
count_books()
